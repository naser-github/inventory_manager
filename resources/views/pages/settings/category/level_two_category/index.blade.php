...
@section('breadcrumb_navigation_path')
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">Level Two Category Management</li>
    <!--end::Item-->
    <!--begin::Item-->
    ...
    <!--end::Item-->
    <li class="breadcrumb-item text-muted">Level Two Categories</li>
    <!--end::Item-->
@endsection
...
@section('page_content')
    <div class="card">
        ...
        <div class="card-body py-4">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_level_two_category">
                <!--begin::Table head-->
                <thead>
                <!--begin::Table row-->
                ...
                @foreach($level_two_categories as $level_two_category)
                    ...
                    <tr>
                        ...
                        <!--begin::Status=-->
                        <td>
                            <span style="display: none">{{$level_two_category->status}}</span>
                            @if( $level_two_category->status==1)
                            ...
                            <div
                                ...
                                <div class="menu-item px-3">
                                    <button type="button" class="menu-link btn btn-sm w-100 px-3"
                                            onclick="editVendor({{$level_two_category->id}})">
...
@section('page_scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#kt_modal_level_two_category_add').modal({
                backdrop: 'static',
                keyboard: false
            })
        });
        ...
        // Begin:: Edit Modal
        $(document).ready(function () {
            $('#kt_modal_level_two_category_edit').modal({
                backdrop: 'static',
                keyboard: false
            })
        });
        ...
        function editVendor(id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{!! route('modal.level_two_category.edit') !!}",
                cache: false,
                data: {
                    _token: "{{csrf_token()}}",
                    'id': id
