    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link @yield('dashboard.index')" href="{{route('dashboard.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon-->
                            <i class="fa-brands fa-gg-circle text-white fs-6"></i>
                            <!--end::Svg Icon-->
                        </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @yield('purchase_inbound')">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link @yield('purchase_inbound.create')"
                               href="{{route('purchase_inbound.create')}}">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link @yield('purchase_inbound.index')"
                               href="{{route('purchase_inbound.index')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
